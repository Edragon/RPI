...
try:
	...
	while 1:
		with canvas(device) as draw:
			...
			if  GPIO.input(KEY1_PIN) == 0 and static == 1: # button is released
			...
			if  GPIO.input(KEY2_PIN) == 0 and static == 1: # button is released
			...
			if  GPIO.input(KEY3_PIN) == 0 and static == 1: # button is released
			...
			while Key1_static + Key2_static + Key3_static == 3:
				draw.rectangle((0, 0,128,64), outline=255, fill=1) #center filled
				break
