...
{	
	...
	if(sLCD_DIS.LCD_Dis_Column <= sLCD_DIS.LCD_Dis_Page){//Horizontal screen display
		...
		GUI_DrawRectangle(0,0,sLCD_DIS.LCD_Dis_Column,10,BLUE, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(0,sLCD_DIS.LCD_Dis_Page - 10,sLCD_DIS.LCD_Dis_Column,sLCD_DIS.LCD_Dis_Page,BLUE, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(1,1,sLCD_DIS.LCD_Dis_Column,sLCD_DIS.LCD_Dis_Page,RED,DRAW_EMPTY,DOT_PIXEL_2X2);
		...
		GUI_DisString_EN(28,45,"1.8inch TFTLCD",&Font8,RED,GRED);
		...
		printf("LCD Draw Realistic circles\r\n");
		GUI_DrawCircle(15, 90, 10, BRRED, DRAW_FULL, DOT_PIXEL_DFT);
		GUI_DrawCircle(sLCD_DIS.LCD_Dis_Column - 15, 90, 10, BRRED, DRAW_FULL, DOT_PIXEL_DFT);

		printf("LCD Display String \r\n");
		GUI_DisString_EN(10,20,"WaveShare Electronic",&Font12,GUI_BACKGROUND,BLUE);
		GUI_DisString_EN(35,35,"1.8inch TFTLCD",&Font12,RED,GRED);

		printf("LCD Display Nummber \r\n");
		GUI_DisNum(35,50,1234567890,&Font12,GUI_BACKGROUND,BLUE);
